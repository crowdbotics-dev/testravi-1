"""
Django settings for testravi_1 project.
...
WSGI_APPLICATION = 'testravi_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testravi_1 API",
    "DESCRIPTION": "API documentation for testravi_1 App",
    "VERSION": "v1",
}
